...
こうやって作っていくうちに Jekyll の記述をミスったりすると、Github側がビルドしてくれなかったりする。そういう場合はどうすればいいかというと、ヘルプには

> ローカルでビルドして確認しろ

みたいなボケたことが書いてある。ローカルでビルド環境用意したくないから Github Pages を使ってるのであってそんな手間暇かけてサイトを更新するなら Jekyll 使う必要も無いし Github Pages でホスティングする必要も無いのである。
