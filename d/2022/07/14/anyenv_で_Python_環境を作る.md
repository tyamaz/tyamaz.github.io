...
Installed Python-3.10.5 to /home/hoge/.anyenv/envs/pyenv/versions/3.10.5
```
...
$ sudo apt install libghc-ncurses-dev
...
```
$ pyenv install 3.10.5
pyenv: /home/ya/.anyenv/envs/pyenv/versions/3.10.5 already exists
...
```
$ pip --version
pip 22.0.4 from /home/hoge/.anyenv/envs/pyenv/versions/3.10.5/lib/python3.10/site-packages/pip (python 3.10)
```
