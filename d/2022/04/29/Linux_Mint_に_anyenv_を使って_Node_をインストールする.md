---
title: Linux_Mint_に_anyenv_を使って_Node_をインストールする
aliases:
  - Linux_Mint_に_anyenv_を使って_Node_をインストールする
tags:
  - d/2022/04/29
---

[Linux_Mint_に_anyenv_を使って_Ruby_をインストールする](../28/Linux_Mint_に_anyenv_を使って_Ruby_をインストールする.md) と似たような感じで。
anyenv はもう入っているという前提
...
メチャある。node はバージョンにシビアな面があるイメージ・・・。

`18.0.0` とやや怖い感じのバージョンがあるがこいつでいく
